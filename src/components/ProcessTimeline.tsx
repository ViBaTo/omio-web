          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  borderColor: '#35606e',
                  backgroundColor: activeStep >= i ? '#35606e' : 'transparent',
                }}
              />

              <div>
                <p className="font-ingeniero text-[11px] tracking-[0.3em] uppercase" style={{ color: '#35606e' }}>
                  {step.label}
                </p>
                <p className="font-body text-sm mt-2" style={{ color: '#35606e', opacity: 0.7 }}>
                  {step.description}
                </p>
              </div>
            </motion.div>
          ...
          return (
            <g key={i}>
              ...
              <circle
                ...
                cy="60"
                r="6"
                fill={isActive ? '#35606e' : 'transparent'}
                stroke="#35606e"
                strokeWidth="1.5"
        ...
        {steps.map((step, i) => {
          ...
          return (
            ...
            >
              ...
              <motion.div
                className="mt-3 px-3 py-2 border border-[#35606e]/20 rounded-none"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: isCurrent ? 1 : 0, y: isCurrent ? 0 : 10 }}
                transition={{ duration: 0.3 }}
              >
                <p className="font-body text-xs" style={{ color: '#35606e', opacity: 0.7 }}>
                  {step.description}
                </p>
              </motion.div>
            </div>
