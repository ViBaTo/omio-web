          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  borderColor: '#002A3A',
                  backgroundColor: activeStep >= i ? '#002A3A' : 'transparent',
                }}
              />

              <div>
                <p className="font-ingeniero text-[11px] tracking-[0.3em] uppercase" style={{ color: '#002A3A' }}>
                  {step.label}
                </p>
                <p className="font-body text-sm mt-2" style={{ color: '#002A3A', opacity: 0.7 }}>
                  {step.description}
                </p>
              </div>
            </motion.div>
          ...
          return (
            <g key={i}>
              ...
              <circle
                ...
                cy="60"
                r="6"
                fill={isActive ? '#002A3A' : 'transparent'}
                stroke="#002A3A"
                strokeWidth="1.5"
        ...
        {steps.map((step, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <p className="font-body text-xs" style={{ color: '#002A3A', opacity: 0.7 }}>
                  {step.description}
                </p>
              </motion.div>
            </div>
